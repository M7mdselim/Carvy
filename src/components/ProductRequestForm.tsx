...
const ProductRequestForm = () => {
  ...
  return (
    <div className={`fixed bottom-24 ${language === 'ar' ? 'left-10' : 'right-10'} z-40`}>
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        ...
        <SheetContent side={language === 'ar' ? 'left' : 'right'} className="w-[85%] sm:w-[400px] p-5 bg-white shadow-lg border border-gray-200">
          <SheetHeader className="mb-5">
            <SheetTitle className="text-lg text-indigo-700">{t('requestProductTitle')}</SheetTitle>
            <SheetDescription className="text-sm text-gray-600">
              {t('requestProductDescription')}
            </SheetDescription>
          </SheetHeader>
