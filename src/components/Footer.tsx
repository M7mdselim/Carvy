      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className={`flex ${language === 'ar' ? 'space-x-reverse' : ''} space-x-4`}>
              <a href="#" className="text-gray-400 hover:text-gray-500 social-icon">
                <span className="sr-only">Facebook</span>
                <svg className="h-6 w-6 no-flip" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-8 border-t border-gray-100">
          <p className="text-gray-400 text-sm text-center">
            © {currentYear} {language === 'ar' ? 'كارڤي' : 'Carvy'}. {t('allRightsReserved')}.
          </p>
        </div>
      </div>
    </footer>
