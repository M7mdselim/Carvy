...
const SearchResults = ({
  ...
  return (
    <div 
      className="absolute top-full left-0 right-0 mt-2 w-full max-w-4xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-300 animate-fade-in"
    ...
    >
      ...
      {searchLoading ? (
        ...
        <div className="max-h-[200vh] overflow-y-auto">
