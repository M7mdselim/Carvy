...
export default function Orders() {
  ...
  return (
    <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12 ${isRtl ? 'rtl' : 'ltr'}`}>
      ...
      <div className="space-y-8">
        {orders.map((order , index) => (
          <div key={order.id} className="bg-white rounded-lg shadow overflow-hidden">
            <div className="px-4 sm:px-6 py-4 border-b bg-gray-100 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-sm text-gray-700">{t('orderId')}:</span>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                <Badge className={`flex items-center gap-1 px-3 py-1 flex-wrap ${getStatusColor(order.status)}`}>
            ...
            <div className="p-4 sm:p-6">
              <div className="mb-4">
                <h3 className="text-base sm:text-lg font-medium mb-2">{t('shippingDetails')}</h3>
              ...
              <h3 className="text-base sm:text-lg font-medium mb-2">{t('orderedItems')}</h3>
              <div className="overflow-x-auto border rounded-lg">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tfoot className="bg-gray-50">
                    <tr>
                      <td colSpan={2} className="px-4 py-4 text-sm font-medium text-gray-900 text-right">
                        {t('total')}:
                      </td>
             ...
             {/* Separator (only if not the last order) */}
